                        ...
                        child: servicerequesttcompletedlist.length > 0
                            ? RefreshIndicator(
                                child: ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount:
                                      servicerequesttcompletedlist.length,
                                  itemBuilder: (context, index) {
                                    return Stack(
                                      alignment: Alignment.bottomCenter,
                                      children: [
                                                  ...
                                                  child: Stack(
                                                    children: <Widget>[
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        Text(
                                                                          servicerequesttcompletedlist[index].servicerqst_vinnumber != null
                                                                        ...
                                                                        Text(
                                                                          servicerequesttcompletedlist[index].servicerqst_sm_name != null
                                                                              ? servicerequesttcompletedlist[index].servicerqst_sm_name
                                                                              : "",
                                                                          style: primaryTextStyle(
                                                                              color: servicerequesttcompletedlist[index].sm_code == "SRR" ? Colors.red : Colors.green,
                                                                              size: 14),
                                                                        ),
                                                                      ],
                                                                    ),
                                                      ...
                                                      Container(
                                                        ...
                                                        margin: EdgeInsets.only(
                                                            top: 16),
                                                        color: servicerequesttcompletedlist[
                                                                        index]
                                                                    .sm_code ==
                                                                "SRCP"
                                                            ? Colors.green
