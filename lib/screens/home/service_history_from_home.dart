...
class ServiceDetailsPageFromHome extends StatefulWidget {
  const ServiceDetailsPageFromHome({super.key});

  @override
  State<ServiceDetailsPageFromHome> createState() =>
      ServiceDetailsPageFromHomeState();
}

class ServiceDetailsPageFromHomeState
    extends State<ServiceDetailsPageFromHome> {
                  ...
                  child: servicerequesttcompletedlist.length > 0
                      ? RefreshIndicator(
                          child: ListView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount: servicerequesttcompletedlist.length,
                                                          ...
                                                          ClipRRect(
                                                            child: Image.asset(
                                                              servicerequesttcompletedlist[
                                                                  ...
                                                                  ? ImageConst
                                                                      .BENZ
                                                                  : servicerequesttcompletedlist[index]
                                                                              .servicerqst_make_name ==
                                                                          'BMW'
                                                                      ? ImageConst
                                                                          .BMW
                                                                      : servicerequesttcompletedlist[index].servicerqst_make_name ==
                                                                              'Skoda'
                                                                          ? ImageConst
                                                                              .SKODA
                                                                ...
                                                                children: <
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: <
                                                                        Widget>[
                                                                      Text(
                                                                        servicerequesttcompletedlist[index].servicerqst_number !=
                                                                                null
                                                                            ? servicerequesttcompletedlist[index].servicerqst_number
                                                                            : "",
                                                                        style:
                                                                      ...
                                                                      Text(
                                                                        servicerequesttcompletedlist[index].servicerqst_date !=
                                                                                null
                                                                            ? DateFormat('dd-MM-yyyy').format(DateTime.tryParse(servicerequesttcompletedlist[index].servicerqst_date)!)
                                                                            : "",
                                                                  ...
                                                                  Text(
                                                                    servicerequesttcompletedlist[index].servicerqst_make_name !=
                                                                            null
                                                                        ? servicerequesttcompletedlist[index].servicerqst_variant_name !=
                                                                                null
                                                                            ? servicerequesttcompletedlist[index].servicerqst_make_name +
                                                                                " " +
                                                                                servicerequesttcompletedlist[index].servicerqst_model_name +
                                                                                " " +
                                                                                servicerequesttcompletedlist[index].servicerqst_variant_name
                                                                  ...
                                                                  Text(
                                                                    servicerequesttcompletedlist[index].servicerqst_vinnumber !=
                                                                            null
                                                                        ? servicerequesttcompletedlist[index]
                                                                  ...
                                                                  Text(
                                                                    servicerequesttcompletedlist[index].servicerqst_sm_name !=
                                                                            null
                                                                        ? servicerequesttcompletedlist[index]
                                                                            .servicerqst_sm_name
                                                                        : "",
                                                                    style: primaryTextStyle(
                                                                        color: servicerequesttcompletedlist[index].sm_code ==
                                                                                "SRR"
                                                                            ? Colors
                                                                                .red
                                                                            : Colors
                                                              ...
                                                              MaterialPageRoute(
                                                                  builder:
                                                                      (context) =>
                                                                          ServiceDetailsPage(
                                                                            servicerqstid:
                                                                                servicerequesttcompletedlist[index].servicerqst_id,
                                                                            make:
                                                                                servicerequesttcompletedlist[index].servicerqst_make_name,
                                                                            vehname: servicerequesttcompletedlist[index].servicerqst_make_name +
                                                                                servicerequesttcompletedlist[index].servicerqst_model_name +
                                                                                servicerequesttcompletedlist[index].servicerqst_variant_name,
                                                                          )));
                                                        },
