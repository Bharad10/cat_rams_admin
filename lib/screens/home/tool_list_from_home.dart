...
class ToolListFromHome extends StatefulWidget {
  const ToolListFromHome({super.key});

  @override
  State<ToolListFromHome> createState() => ToolListFromHomeState();
}

class ToolListFromHomeState extends State<ToolListFromHome> {
                                                                ...
                                                                children: <
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: <
                                                                        Widget>[
                                                                      Text(
                                                                        toolrequestpendinglist[index].toolrqst_tool_name !=
                                                                                null
                                                                            ? toolrequestpendinglist[index].toolrqst_tool_name
                                                                            : "",
                                                                        style:
                                                                  ...
                                                                  Text(
                                                                    toolrequestpendinglist[index].toolrqst_date !=
                                                                            null
                                                                        ? DateFormat('dd-MM-yyyy')
                                                                            .format(DateTime.tryParse(toolrequestpendinglist[index].toolrqst_date)!)
                                                                        : "",
                                                                    style: primaryTextStyle(
                                                                        size:
                                                                            16),
                                                          ...
                                                          Navigator.push(
                                                              ...
                                                              MaterialPageRoute(
                                                                  builder: (context) =>
                                                                      ToolDetailsPage(
                                                                          toolrstid:
                                                                              toolrequestpendinglist[index].toolrqst_id)));
                                                        },
                                                      ),
                                                    ],
                                                  ),
